...
import { FontAwesome5, Entypo, FontAwesome, Ionicons, MaterialCommunityIcons, AntDesign, Feather } from '@expo/vector-icons';
...
const SelectableTask = ({ navigation, route, task, onPress, onDelete, scale, opacity, selectedTasks, showMovePopUp, showEditPopUp, showCompleteModal }) => {
          ...
          <View style={{ flexDirection: 'column', width: (isMenuVisible ? '100%' : '88%') }}>
            <View style={styles.innerContainer}>
              <View style={[
                ...
                <Text numberOfLines={1} style={{ color: Colors[theme].white, textAlign: 'center', fontSize: 15, fontWeight: (isMenuVisible && !selectedTasks[task.task_id] ? 'bold' : 'normal'), marginRight: '5%' }}>
                ...
                <TouchableWithoutFeedback
                  ...
                  onPress={() => {
                    navigation.navigate('Details', { task, lastScreen: route })
                  }}
                >
                  <Feather name="info" size={18} color={Colors[theme].white} />
                </TouchableWithoutFeedback>
              </View>
              <View
                style={[
