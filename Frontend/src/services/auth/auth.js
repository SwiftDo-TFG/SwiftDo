...
const getAuthToken = async (authcode) => {
    const data = { client_id: 1234, client_secret: 1234, grant_type: "authorization_code", code: authcode, redirect_uri: 'http://ec2-51-20-55-15.eu-north-1.compute.amazonaws.com:3000/' }
...
const restoreToken = async (token)=> {
    const data = { client_id: 1234, client_secret: 1234, grant_type: "refresh_token", refresh_token: token.refresh_token, redirect_uri: 'http://ec2-51-20-55-15.eu-north-1.compute.amazonaws.com:3000/' }
