...
const getAuthToken = async (authcode) => {
    const data = { client_id: 1234, client_secret: 1234, grant_type: "authorization_code", code: authcode, redirect_uri: 'http://ec2-16-16-226-94.eu-north-1.compute.amazonaws.com:3000/' }
